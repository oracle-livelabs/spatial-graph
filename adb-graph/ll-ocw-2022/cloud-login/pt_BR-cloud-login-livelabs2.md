...
1. Using your *Oracle Account Login* go to [LiveLabs 2.0](http://developer.oracle.com/livelabs) and click  ![](images/reserve.png) to request a reservation for this workshop.
